...
139: ADD 500 391  // lastresult = lastresult + stack[ptr + 1]
140: ADD 350 292  // ptr = ptr - 3
141: CP  390 350  // tmp0 = ptr
142: ADDi 390 5   // tmp0 = ptr + 5 
143: CPI 390 390  // tmp0 = stack[ptr + 5]
144: BZJi 390 0   // goto stack[ptr + 5]
